 ...
 */
public class Fragment_pf extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Posisi Power Forward");
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_fragment_pf, container, false);
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if ( jsonObject.getString("Position").equalsIgnoreCase("Power Forward")) {
