 ...
 */
public class Fragment_cen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Posisi Center");
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_fragment_cen, container, false);
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if ( jsonObject.getString("Position").equalsIgnoreCase("Center")) {
