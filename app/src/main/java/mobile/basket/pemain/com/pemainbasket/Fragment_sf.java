 ...
 */
public class Fragment_sf extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Posisi Small Forward");
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_fragment_sf, container, false);
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if ( jsonObject.getString("Position").equalsIgnoreCase("Small Forward")) {
